...
Route::prefix('admin')->middleware('auth')->group(function(){
    ...
    Route::get('/authorSearch','SearchController@authorSearch')->name('authorSearch');
    Route::get('/eventSearch','SearchController@eventSearch')->name('eventSearch');
    Route::get('/periodSearch','SearchController@periodSearch')->name('periodSearch');
